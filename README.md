...
**Docs:** [Governance & threat model](docs/GOVERNANCE.md) · [Candid comparison vs Paperclip/MetaGPT/CrewAI/LangGraph](docs/COMPARISON.md) · [The Registrar](registrar/README.md)
...
# Additional Ollama models are pulled manually: docker exec aef2_ollama ollama pull <model>
...
# Pull a model
docker exec aef2_ollama ollama pull llama3.2:latest

# Remove a model
docker exec aef2_ollama ollama rm llama3.2:latest

# Interactive shell in Ollama
docker exec -it aef2_ollama ollama run llama3.2:latest
...
docker exec aef2_hermes pkill -SIGHUP hermes
...
docker inspect --format='{{.State.Health.Status}}' aef2_hermes
...
docker inspect --format='{{.State.Health.Status}}' aef2_litellm
```
