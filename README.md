...
│  │  llama3.1 · mistral · gemma2  │  │  filesystem · memory · fetch       │ │
│  │  codellama · nomic-embed      │  │  github · postgres · surreal · dock│ │
│  └───────────────────────────────┘  └────────────────────────────────────┘ │
├─────────────────────────────────────────────────────────────────────────────┤
...
The Homepage dashboard (running on port `3030`) by default has strict host validation, which can prevent access when trying to reach it via a local IP address (e.g., `http://10.10.10.27:3030`).
